...
d_surround = [mention_doc1.translate(None,string.punctuation).lower().split(), mention_doc2.translate(None,string.punctuation).lower().split(), mention_doc3.translate(None,string.punctuation).lower().split(), mention_doc4.translate(None,string.punctuation).lower().split(), mention_doc5.translate(None,string.punctuation).lower().split(), mention_doc6.translate(None,string.punctuation).lower().split(), mention_doc7.translate(None,string.punctuation).lower().split(), mention_doc8.translate(None,string.punctuation).lower().split(), mention_doc9.translate(None,string.punctuation).lower().split(), mention_doc10.translate(None,string.punctuation).lower(), mention_doc11.translate(None,string.punctuation).lower(), mention_doc12.translate(None,string.punctuation).lower(), mention_doc13.translate(None,string.punctuation).lower(), mention_doc14.translate(None,string.punctuation).lower(), mention_doc15.translate(None,string.punctuation).lower(), mention_doc16.translate(None,string.punctuation).lower(), mention_doc17.translate(None,string.punctuation).lower()]
...
query_text = "Barcelona has a warm weather, specially in summer."
query_text = query_text.translate(None, string.punctuation).lower().split()
query_text = [word for word in query_text if word not in cachedStopWords]
lned.run_doc_query(query_text)
lned.get_doc_query_dist()
